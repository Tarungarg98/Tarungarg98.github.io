...
const Zomato = () => {
  ...
  const brief = (
    <div>
      ...
      opportunity to lead marketing-related Data Science projects and work on
      diverse, high-impact initiatives spanning user acquisition, logistics
      optimization, personalization, and marketing analytics. Currently heading
      the marketing Data Science vertical, I've driven projects ranging from
      building pLTV models for Google Ads to optimizing retargeting campaigns
      and rider earnings through intelligent shift recommendations. Each project
      directly contributes to enhancing user experience and operational
      efficiency at scale. Collaborating closely with stakeholders like{" "}
      <a
